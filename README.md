# ⚡ Kontroler Otomasi Akuarium Air Tawar & Laut ESP32
...
Sistem terpadu pengatur suhu akuarium (Heater/Chiller), kontrol simulasi pencahayaan matahari terbit/tenggelam PWM, auto-feeder, dan monitor level air.
...
1. Buka file **`esp32-smart-aquarium-controller.ino`** menggunakan **Arduino IDE 2.0+** atau PlatformIO.
